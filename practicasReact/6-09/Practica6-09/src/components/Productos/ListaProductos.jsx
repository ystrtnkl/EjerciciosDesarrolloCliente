  ...
  return (
    <div>
      {/*Los usuarios sin la sesión iniciada no pueden ver esta parte.*/ props.controles && (<div>
        <button onClick={() => {navegar("/nuevoProducto")}}>Agregar nuevo producto</button><br />
      ...
      <div className="lista-productos" onClick={props.botonAgnadir && clickProducto}>
