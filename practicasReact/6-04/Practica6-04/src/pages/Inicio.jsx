...
function Inicio() {
  ...
  return (
    <>
      ...
      <p>Lamentablemente la API no devuelve más de 10 objetos, así que el número de pelílculas, naves, vehículos y personajes estará limitado a 10 a la vez.</p>
      <p>Consultar NOTAS.txt para ver porque las películas se descargan al inicio pero los personajes, naves y vehículos se piden a la API cada vez.</p>
    </>
  )
}
