...
//Página para mostrar los detalles de un vehículo en concreto, similar al componente PersonajeConcreto.
function VehiculoConcreto() {
  ...
  const { id } = useParams();  //El id del vehículo a buscar en la API es el que aparezca en la url.
  const [vehiculo, setVehiculo] = useState({}); //Estado con los detalles del vehículo.
